...
import com.ntt.apitester.dto.of.Filter;
import com.ntt.apitester.dto.of.RelatedNetworkRequestBody;
...
@Slf4j
@Component
public class RelatedNetworkTest {
    ObjectMapper objectMapper = new ObjectMapper();

    //private String host = "http://localhost:8080";
    private String host = "https://claawiopaa11.aws.openfiber.it";
    private String endPoint = "/networkitems/v1/relatednetwork";
...
//    private String cookieAuth;
    ...
    private List<String> includedTypesHighZoomLevel = Arrays.asList("POP", "PFP", "PFS", "APPARATO_EDIFICIO", "PD", "EDIFICIO");

    private List<RelatedNetworkRequestBody> elementsToTest = Arrays.asList(
            //Request 1
                RelatedNetworkRequestBody.builder()
                    .name("10_054_054005_8000441798_15")
                    .elementType("EDIFICIO")
                    .zoom(20.0)
                    .includeTypes(includedTypesHighZoomLevel)
                    .filter(Filter.builder()
                            .lat(42.83355479)
                            .lng(12.767481239999995)
                            .radius(93.32527232980577)
                            .build()).build(),
             //Request 2
                RelatedNetworkRequestBody.builder()
                        .name("10_054_054005_8000441382_1")
                        .elementType("EDIFICIO")
                        .zoom(20.0)
                        .includeTypes(includedTypesHighZoomLevel)
                        .filter(Filter.builder()
                                .lat(42.82261333999998)
                                .lng( 12.766532059999998)
                                .radius(91.31264737199234)
                            .build()).build()
    );
    ...
    public void test() throws Exception{
        ...
        for(RelatedNetworkRequestBody element : elementsToTest){
            String jsonBody = objectMapper.writeValueAsString(element);

            String nomeFile = element.getName() + "_" + element.getName() + "_" + element.getName() + "_" + element.getFilter().getLat() + "_" + element.getFilter().getLng();
